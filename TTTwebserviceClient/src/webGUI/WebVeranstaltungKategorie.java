 ...
 */
public class WebVeranstaltungKategorie extends javax.swing.JFrame {

    private WebVeranstaltungKategorieCtrl _ctrl;

    /**
     * Creates new form CorbaVeranstaltungKategorie
     */
    public WebVeranstaltungKategorie(WebVeranstaltungKategorieCtrl ctrl) {
        _ctrl = ctrl;
        initComponents();
        loadComponents();
    ...
    private void initComponents() {
        ...
        if (_tblKategorien.getColumnModel().getColumnCount() > 0) {
